#!/bin/bash
# coded by WHOAMI-XD (DEVIL-MASTER)
# Created since on 10/02/2022 made in Nigeria by WHOAMI (DEVIL-MASTER)
# If You Take Money For This Little Tool Bash Script Please Look At Your Self Again And Shame To You.
# visit our WHATSAPP GROUP https://chat.whatsapp.com/DJOEYuW25xiEhX11ZeldUP
clear
sleep 0.5
echo ""
echo "  [VISIT https://chat.whatsapp.com/DJOEYuW25xiEhX11ZeldUP TO LEARN MORE]"|lolcat
...
echo "  [CREATED BY: WHOAMI-XD]"|lolcat
sleep 0.5
echo ""
...
echo ""
echo ""
echo "VISIT https://chat.whatsapp.com/DJOEYuW25xiEhX11ZeldUP TO LEARN MORE."
